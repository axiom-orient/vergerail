...
현재 checkout은 Apple silicon macOS, Codex `0.149.1`, Rust `1.97.1` 이상을 지원합니다. local path dependency와 고정 runtime 흐름을 검증할 수 있습니다. GitHub와 crates.io에는 아직 배포하지 않았습니다. 상세 증거와 배포 조건은 [검증](docs/VERIFICATION.md)과 [배포](docs/RELEASE.md) 문서가 관리합니다.
